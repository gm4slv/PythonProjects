...
def tune_carrier(pwr, time):
    ...
    tunestream = p.open(format=pyaudio.paInt16, channels=1, rate=9600, output=1)
    frequency = 1700
    length = 3
    #length = time
    rate = 9600 * sr_corr
