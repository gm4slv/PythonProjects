...
class nRadio(object):
    ...
    def set_mode(self, mode, radio):
        ...
        try:
            ...
            print "unable to set fldigi mode"
        return
    ...
    def fld_poll(self):
        ...
        print "radio mode %s , fld mode %s" % (radio_mode, fld_rigmode)
        if fld_rigmode != radio_mode:
            print "setting rig mode to ", fld_rigmode
            self.set_mode(fld_rigmode, self.num)
            self.fld_set_rigmode(fld_rigmode)
        self.fld_trx()
        return
    ...
    def fld_set_rigmode(self, mode):
        print "in fld_set_rigmode with ", mode
