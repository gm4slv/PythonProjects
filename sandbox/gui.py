...
class Network(object):
    ...
    def make_con(self):
        ...
        self.sock.connect(("192.168.21.6", 9999))
        return self.sock
...
class Dash(object):
    ...
    def up_dash(self):
        self.server_msg = n1.connect("listradios")
...
class nRadio(object):
    def __init__(self, master, radio):
        ...
        self.b_smeter_clear = Button(radio_frame, text = "Clear SM", width = 4 , command = lambda: self.clear_smeter(self.num))
        self.b_smeter_clear.grid(row = 4, column = 2)
        ...
        self.c1 = Canvas(radio_frame, width=245, height=100, bg='black')
