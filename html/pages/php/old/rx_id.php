...
echo "<center>Receiver ID = " . $rx_id . "</center><br>";
...
{
$ecc="%";
echo "ECC : OK and ERR<br><br>";
}
else
{
$ecc="OK";
echo "ECC : OK only<br><br>";
}
...
$result = mysqli_query($con,"SELECT * FROM newlog where datetime > date_sub(utc_timestamp(), interval 24 hour) and RX_ID = '".$rx_id."' and ECC like '%".$ecc."%' $tilde_string $notest_string $urgdis_string order by datetime desc");
