...
This searches for the latest 50 messages between two specified MMSIs.<br>
Use it to follow Call/Ack sequences etc.<br>
It will be refined to allow choice of Telecommand (e.g. ignoring TEST calls etc.) and specific frequencies, dates etc. later<br>
<br>
<table cellpadding=10>
<th>Enter First MMSI</th>
<th>Enter Second MMSI</th>
<tr>
<td>
...
<td>
<input type="text" name="ship_mmsi">
</td>
</tr>
</table>
<!--
...
<center><br><a href="./search_qso_index.php">BACK</a></body>
</html>
