...
echo "<h3>Showing last 50 messages between $coast_mmsi and $ship_mmsi</h3>";
...
$result = mysqli_query($con, " select * from newlog where tc1 not like '%test%' and (  (raw_to_mmsi = ".$coast_mmsi." and raw_from_mmsi = ".$ship_mmsi.") or (raw_to_mmsi=".$ship_mmsi." and raw_from_mmsi=".$coast_mmsi.")) order by datetime desc limit 50");
...
<center><br><a href="./search_qso_index.php">TRY AGAIN</a></body>
</html>
