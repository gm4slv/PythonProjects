...
$result = mysqli_query($con, " select * from newlog where  (  (raw_to_mmsi = ".$coast_mmsi." and raw_from_mmsi = ".$ship_mmsi.") or (raw_to_mmsi=".$ship_mmsi." and raw_from_mmsi=".$coast_mmsi.")) order by datetime desc limit 50");
