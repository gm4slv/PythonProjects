...
echo "<h3>Showing last 24 hours messages from ".$rxid." on ".$rx_freq."</h3>";
...
if (mysqli_connect_errno($con))
  ...
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
      ...
      $result = mysqli_query($con,"SELECT * FROM newlog where ".$DATEQUERY." and RX_ID like '%".$rxid."%' and RX_FREQ like '%".$rx_freq."%' order by datetime desc");
