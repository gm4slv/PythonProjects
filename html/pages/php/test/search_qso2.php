...
echo "<h3>Showing last 50 messages between $coast_mmsi and any ship</h3>";
...
$result = mysqli_query($con, " select * from newlog where TC1 not like '%test%' and  (  (RAW_TO_MMSI = ".$coast_mmsi." and FROM_TYPE='SHIP') or (TO_TYPE='SHIP' and RAW_FROM_MMSI=".$coast_mmsi.")) order by datetime desc limit 50");
