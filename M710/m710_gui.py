...
class m710(object):
    def __init__(self, master):
        ...
        self.rx_l = Label(control_frame, textvariable=self.rx_freq, width = 10, bg='black', fg="green", font=("",16, "bold"))
        ...
        self.tx_l = Label(control_frame, textvariable=self.tx_freq, bg='black', fg="green", font=("",16,"bold"), width = 10)
        ...
        self.qsy1m_r = Radiobutton(delta_frame, indicatoron=0, bg='grey50', font=("",10,''), selectcolor='green', width=6, text="1MHz", variable=self.delta, value="1000")
        self.qsy1m_r.grid(row = 1, column = 0, padx=3)
        self.qsy100k_r = Radiobutton(delta_frame, indicatoron=0,bg='grey50', font=("",10,''), selectcolor='green', width=6, text="100kHz", variable=self.delta, value="100")
        self.qsy100k_r.grid(row = 1, column = 1, padx=3)
        self.qsy10k_r = Radiobutton(delta_frame,  indicatoron=0,bg='grey50',font=("",10,''), selectcolor='green', width=6, text="10kHz", variable=self.delta, value="10")
        self.qsy10k_r.grid(row = 1, column = 2, padx=3)
        self.qsy1k_r = Radiobutton(delta_frame,  indicatoron=0,bg='grey50',font=("",10,''), selectcolor='green', width=6, text="1kHz", variable=self.delta, value="1")
        self.qsy1k_r.grid(row = 1, column = 3, padx=3)
        self.qsy500h_r = Radiobutton(delta_frame, indicatoron=0,bg='grey50',font=("",10,''), selectcolor='green', width=6, text="500Hz", variable=self.delta, value="0.5")
        self.qsy500h_r.grid(row = 1, column = 4,padx=3)
        self.qsy100h_r = Radiobutton(delta_frame, indicatoron=0,bg='grey50',font=("",10,''), selectcolor='green', width=6, text="100Hz", variable=self.delta, value="0.1")
        ...
        self.usb_r = Radiobutton(mode_frame, text = "USB",bg='grey50',  selectcolor='green', font=("",10,'bold'), indicatoron=0, width=5, variable = self.mode, value = "USB", command = lambda: self.new_mode("USB"))
        self.usb_r.grid(row = 1, column = 0,padx=3,pady=3)
        self.lsb_r = Radiobutton(mode_frame, text = "LSB", bg='grey50', selectcolor='green', font=("",10,'bold'),indicatoron=0, width=5, variable = self.mode, value = "LSB", command = lambda: self.new_mode("LSB"))
        self.lsb_r.grid(row = 1, column = 1,padx=3,pady=3)
        self.cw_r = Radiobutton(mode_frame, text = "AM",bg='grey50', selectcolor='green', font=("",10,'bold'), indicatoron=0, width=5, variable = self.mode, value = "AM", command = lambda: self.new_mode("AM"))
        self.cw_r.grid(row = 1, column = 2,padx=3,pady=3)
        self.am_r = Radiobutton(mode_frame, text = "CW",bg='grey50',  selectcolor='green', font=("",10,'bold'),indicatoron=0, width=5, variable = self.mode, value = "CW", command = lambda: self.new_mode("CW"))
        self.am_r.grid(row = 1, column = 3,padx=3,pady=3)
        self.j2_r = Radiobutton(mode_frame, text = "J2B", bg='grey50', selectcolor='green', font=("",10,'bold'),indicatoron=0, width=5,  variable = self.mode, value = "J2B", command = lambda: self.new_mode("J2B"))
        self.j2_r.grid(row = 1, column = 4,padx=3,pady=3)
        self.fsk_r = Radiobutton(mode_frame, text = "FSK",bg='grey50', selectcolor='green', font=("",10,'bold'), indicatoron=0,width=5,  variable = self.mode, value = "FSK", command = lambda: self.new_mode("FSK"))
        self.fsk_r.grid(row = 1, column = 5,padx=3,pady=3)
        self.r3e_r = Radiobutton(mode_frame, text = "R3E",bg='grey50', selectcolor='green', font=("",10,'bold'), indicatoron=0,width=5, variable = self.mode, value = "R3E", command = lambda: self.new_mode("R3E"))
