...
# /dev/radio is a symlink added by udev to give a consistent name
# to the usb-serial port adaptor plugged into a specific USB port.
# to avoid clashing with the USB GPS device.
#
sport = '/dev/radio'
#sport = '/dev/ttyUSB1'
#sport = 'COM1'
