...
ABOUT_TEXT = "Wire2waves DSC Coast Station : GMDSS DSC Coast Station Monitor \n\n version "+ version + '''\n\n
    Copyright (C) 2015  John Pumford-Green
    Wire2Waves Ltd
    Shetland
...
class Application(Frame):
    ...
    def make_con(self):
        ...
        if self.con:
            ...
            self.reply = n1.login("login guest")
            ...
            self.challenge_client(self.username, self.random, self.salt, "guest")
    ...
    def status_poll(self):
        ...
        root.title("Wire2waves DSC Coast Station Monitor " + version + "         "+self.datenow+"  "+self.timenow+" UTC ")
