...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.motd_term = ScrolledText(self.f4, takefocus=0, width=120, height=18, wrap=WORD, bg='#b0c4de', font=('sans',9,''))
        ...
        self.l_reply9.grid(row=6, column=0, sticky=E+W)
        ...
        self.l_reply5.grid(row=7, column=0,  sticky=E+W)
    ...
    def status_poll(self):
        ...
        if self.status_queue.qsize():
            ...
            self.l_reply9.configure(fg = '#444444')        
