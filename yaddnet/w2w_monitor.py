...
import threading
import Queue
#HOST, PORT = "192.168.21.107", 50669
...
def write_file(text):
    filename = r'/var/www/html/pages/php/test/tmp/snargate_status.html'
    f = open(filename, 'w')  #
...
def write_syslog(text):
    filename = r'/var/www/html/pages/php/test/tmp/snargate_syslog.txt'
    f = open(filename, 'w')
    f.write(text)
    f.close()         
        
def write_rxtx(text):
    filename = r'/var/www/html/pages/php/test/tmp/snargate_rxtx.txt'
    f = open(filename, 'w')
    f.write(text)
    f.close()  

def write_motd(text):
    filename = r'/var/www/html/pages/php/test/tmp/snargate_motd.txt'
    f = open(filename, 'w')
    f.write(text)
    f.close()  
       
def write_txpwr(text):
    filename = r'/var/www/html/pages/php/test/tmp/snargate_txpwr.txt'
    f = open(filename, 'w')
...
def status_handle(status):
    ...
    try:
        ...
        text = text + "<center><br><br><iframe width=800 height=180 style=\"border:none\" src=\"./snargate_motd.txt\"></iframe></center>"
	write_file(text)
    except:
    	pass
    return
