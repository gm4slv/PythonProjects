...
def load_resolve(mmsi, name, call):
    db = sqlite3.connect("/home/gm4slv/coaststation/resolve.db")
    cur = db.cursor()
...
def load_admin(message):
    db = sqlite3.connect("/home/gm4slv/coaststation/admin.db")
    cur = db.cursor()
...
def load_checklog(time, freq, tr, mmsi, name, call, tc1, eos, id):
    db = sqlite3.connect("/home/gm4slv/coaststation/check.db", timeout=5)
    cur = db.cursor()
...
def get_checklog():
    db = sqlite3.connect("/home/gm4slv/coaststation/check.db")
    with db:
        cur = db.cursor()
...
def load_rxtx(time, freq, tr, mmsi, name, call, tc1, eos, id):
    db = sqlite3.connect("/home/gm4slv/coaststation/rxtx.db", timeout=5)
    cur = db.cursor()
...
def get_rxtx():
    db = sqlite3.connect("/home/gm4slv/coaststation/rxtx.db")
    with db:
        cur = db.cursor()
...
def load_rx(time, freq, rx, mmsi, name, call, tc1, eos):
    db = sqlite3.connect("/home/gm4slv/coaststation/calls.db")
    cur = db.cursor()
...
def load_tx(time, freq, mmsi, name, call, tc1, eos):
    db = sqlite3.connect("/home/gm4slv/coaststation/calls.db", timeout=5)
    cur = db.cursor()
