...
class Application(Frame):
    ...
    def shutdown(self):
        ...
        if self.shutdown_allowed:
            if askyesno('Confirm', 'Really Shutdown Server?', default='no'):
    ...
    def create_widgets(self):
        ...
        ######### THE TEXT AREAS ##############
        self.sys_term = ScrolledText(self.f1, takefocus=0, pady=0, borderwidth=0, fg='black', bg='#b0c4de', width = 120, height = 18, wrap = WORD)
        ...
        self.motd_term = ScrolledText(self.f4, takefocus=0, width=120, height=18, wrap=WORD, bg='#b0c4de')
...
def poll_cmd(cmd):
    ...
    sendcommand = header+";"+cmd+";"+version+";"+id     # build the command string - a ";" delimited string with ID as the last element
